...
- `evaluation/asr-report.json`、`layout-qa.json`、`technical-qa.json`：逐段盲 ASR、角色图片比例、397 个文本容器、Card System V2、Scene Grammar V2、Character Performance V2 的 cue-bound 姿态节拍，以及音画/黑帧/冻结段/字幕同步门槛。
